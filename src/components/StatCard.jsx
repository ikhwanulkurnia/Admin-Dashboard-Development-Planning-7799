...
const StatCard = ({ title, value, icon, color = 'primary', index = 0 }) => {
  ...
  return (
    <motion.div
      className="bg-white p-4 rounded-xl shadow-sm border hover:shadow-md transition-shadow duration-200"
    ...
    >
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xl font-bold text-dark">{value.toLocaleString()}</p>
        </div>
