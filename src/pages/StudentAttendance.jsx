...
const StudentAttendance = () => {
  ...
  const attendances = [
    ...
    },
    {
      ...
      timeIn: '-',
      timeOut: '-',
      note: 'Sakit, surat dari orang tua'
    },
    {
      id: 4,
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <div>
          <h1 className="text-lg font-bold text-dark mb-1">Report Absensi Siswa</h1>
          <p className="text-xs text-gray-600">Laporan kehadiran siswa</p>
        </div>
