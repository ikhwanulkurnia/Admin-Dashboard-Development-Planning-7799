...
const CourseManagement = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <div>
          <h1 className="text-lg font-bold text-dark mb-1">Manajemen Kursus</h1>
          <p className="text-xs text-gray-600">Kelola semua kursus yang tersedia di platform</p>
        </div>
              ...
              {filteredCourses.map((course, index) => (
                ...
                >
                  <td className="px-4 py-3 whitespace-nowrap">
                    <div>
                      <div className="text-xs font-medium text-dark">{course.name}</div>
