...
const Memorization = () => {
  ...
  const memorizationData = [
    {
      ...
      date: '2023-05-15',
      status: 'excellent',
      notes: 'Hafalan sangat lancar dan tajwid baik'
    },
    {
      id: 2,
      ...
      date: '2023-05-14',
      status: 'good',
      notes: 'Hafalan lancar dengan beberapa koreksi tajwid'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      date: '2023-05-13',
      status: 'excellent',
      notes: 'Hafalan sangat lancar dengan tajwid yang sempurna'
    }
  ];

  const classes = ['all', '7A', '7B', '7C', '8A', '8B', '8C', '9A', '9B', '9C'];

  const filteredMemorizations = memorizationData.filter(memo => {
    const matchesSearch = memo.student.toLowerCase().includes(searchTerm.toLowerCase()) || 
                         memo.surah.toLowerCase().includes(searchTerm.toLowerCase());
    const matchesClass = selectedClass === 'all' || memo.class === selectedClass;
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <div>
          <h1 className="text-lg font-bold text-dark mb-1">Hafalan Siswa</h1>
          <p className="text-xs text-gray-600">Pencatatan dan pemantauan hafalan Al-Qur'an siswa</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredMemorizations.map((memo, index) => (
                <motion.tr
                  key={memo.id}
                ...
                >
                  <td className="px-4 py-3 whitespace-nowrap">
                    <div className="text-xs font-medium text-dark">{memo.student}</div>
                  </td>
                  <td className="px-4 py-3 whitespace-nowrap">
