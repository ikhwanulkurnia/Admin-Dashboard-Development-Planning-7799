...
const TahsinReport = () => {
  ...
  const reportData = [
    {
      ...
      fluency: 'B+',
      grade: 'A-',
      teacherNote: 'Perkembangan sangat baik dalam penguasaan makharij huruf'
    },
    {
      id: 2,
      ...
      fluency: 'A-',
      grade: 'A-',
      teacherNote: 'Tajwid sangat baik, perlu meningkatkan makharij huruf'
    },
    {
      id: 3,
      ...
      fluency: 'B-',
      grade: 'B',
      teacherNote: 'Perlu latihan lebih konsisten'
    },
    {
      id: 4,
      ...
      fluency: 'A',
      grade: 'A',
      teacherNote: 'Penguasaan tahsin sangat baik dan konsisten'
    }
  ];
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <div>
          <h1 className="text-lg font-bold text-dark mb-1">Laporan Tahsin</h1>
          <p className="text-xs text-gray-600">Laporan perkembangan tahsin Al-Qur'an siswa</p>
        </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredReports.map((report, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 whitespace-nowrap">
                    {getGradeBadge(report.makharij)}
                  </td>
                  <td className="px-4 py-3 whitespace-nowrap">
                    {getGradeBadge(report.tajwid)}
                  </td>
                  <td className="px-4 py-3 whitespace-nowrap">
                    {getGradeBadge(report.fluency)}
                  </td>
                  <td className="px-4 py-3 whitespace-nowrap">
