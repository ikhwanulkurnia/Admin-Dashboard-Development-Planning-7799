...
const AdabReport = () => {
  ...
  const reportData = [
    {
      ...
      adabDiri: 'A',
      grade: 'A',
      teacherNote: 'Sangat baik dalam menerapkan adab sehari-hari'
    },
    {
      id: 2,
      ...
      adabDiri: 'A-',
      grade: 'A',
      teacherNote: 'Konsisten dalam menerapkan adab di sekolah maupun di rumah'
    },
    {
      id: 3,
      ...
      adabDiri: 'B+',
      grade: 'B',
      teacherNote: 'Perlu bimbingan lebih untuk adab sosial'
    },
    {
      id: 4,
      ...
      adabDiri: 'A',
      grade: 'A',
      teacherNote: 'Menunjukkan adab dan akhlak yang sangat baik'
    }
  ];
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <div>
          <h1 className="text-lg font-bold text-dark mb-1">Laporan Adab dan Akhlak</h1>
          <p className="text-xs text-gray-600">Laporan perkembangan adab dan akhlak siswa</p>
        </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredReports.map((report, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 whitespace-nowrap">
                    {getGradeBadge(report.adabIbadah)}
                  </td>
                  <td className="px-4 py-3 whitespace-nowrap">
                    {getGradeBadge(report.adabSosial)}
                  </td>
                  <td className="px-4 py-3 whitespace-nowrap">
                    {getGradeBadge(report.adabBelajar)}
                  </td>
                  <td className="px-4 py-3 whitespace-nowrap">
                    {getGradeBadge(report.adabDiri)}
                  </td>
                  <td className="px-4 py-3 whitespace-nowrap">
